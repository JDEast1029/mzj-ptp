const api = {
	// UPLOAD
	RC_URL_UPLOAD_IMG_POST: '/uploadfile/upimg.json?action=uploadimage&encode=utf-8&code=xqb',
	RC_URL_UPLOAD_FILE_POST: '/uploadfile/upimg.json?action=uploadfile&encode=utf-8&code=xqb',
	// PGALLERY
	// 分类列表
	...
	// 图片上传地址（oss）
	RC_URL_PGALLERY_IMGS_UPLOAD_POST: '/uploadfile/upimg.json?action=uploadimage&encode=utf-8&code=xqb',
