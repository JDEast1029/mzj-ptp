...
export const materialCategory = (state = initialState, action) => {
	let curPage, totalPage, totalCount, items, id, type;
	switch (action.type) {
		case types.MATERIAL_CATEGORY_LIST_GET + "_ON":
			state = {
				...state,
				isEnd: 1
			};
		...
		case types.MATERIAL_CATEGORY_LIST_GET + "_SUCCESS":
			...
			return state;
		case types.MATERIAL_CATEGORY_LIST_GET + "_SETPAGE":
			state = {
				...state,
			...
			return state;
		case types.MATERIAL_CATEGORY_LIST_GET + "_ERROR":
			state = {
				...state,
				isEnd: 0
			};
		...
		case types.MATERIAL_LIST_ROOM_DEL_POST + "_SUCCESS":
		case types.MATERIAL_LIST_UPDATE_SORT_GET + "_SUCCESS":
			state = {
				...initialState,
			};
			return state;
		case types.MATERIAL_CATEGORY_MODEL_COMMUNITY_LIST_POST + '_SUCCESS':
			state = {
				...initialState,
				resetPage: state.resetPage
			};
			return state;
		case types.MATERIAL_CATEGORY_MODEL_MATERIAL_LIST_POST + '_SUCCESS':
			state = {
				...initialState,
				resetPage: state.resetPage
			};
